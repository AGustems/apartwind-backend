...
// SEARCH FOR THE ADDS POSTED CONTROLLER 
const getAdds = async(req, res, next) => {
  try {
...
// SEARCH FOR ALL THE OFFERS MADE CONTROLLER
...
// DELETE AN OFFER CONTROLLER
const retrieveOffer = async(req, res, next) => {
  try {
